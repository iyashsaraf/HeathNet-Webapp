...
public class LabAssistantWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public LabAssistantWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization,
            EcoSystem business) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : labOrganization.getWorkQueue().getWorkRequests()) {
            ...
            row[4] = ((PatientTreatmentWorkRequest) request).getPatient().getFirstName() + " "
                    + ((PatientTreatmentWorkRequest) request).getPatient().getLastName();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(20, 120, 730, 90);
        ...
        add(btnProcess);
        btnProcess.setBounds(380, 310, 140, 30);
        ...
        if (request.getLabAssistant() == null) {
            if (request.getStatus().equalsIgnoreCase("SentToLab")) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Cannot assign this lab request as the current status is: " + request.getStatus());
            }
        } else {
        ...
        if (request.getLabAssistant() != null) {
            if (userAccount.equals(request.getLabAssistant())) {
                if (request.getStatus().equalsIgnoreCase("Pending on Lab Assistant")) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Cannot process the request as the status is: " + request.getStatus());
                }
