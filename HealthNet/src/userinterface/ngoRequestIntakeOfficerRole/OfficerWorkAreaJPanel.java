...
public class OfficerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private ngoRequestIntakeOfficerOrganization NgohealthCareOfficerOrganization;
    ...
    public OfficerWorkAreaJPanel(JPanel jpanel, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        ...
        this.NgohealthCareOfficerOrganization = (ngoRequestIntakeOfficerOrganization) organization;
    ...
    private void initComponents() {
        ...
        lblHealthOfficer.setBackground(new java.awt.Color(0, 0, 0));
        lblHealthOfficer.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblHealthOfficer.setForeground(new java.awt.Color(153, 255, 204));
        lblHealthOfficer.setText("WORK-AREA NGO REQUEST INTAKE OFFICER");
        ...
        tblWorkRequest.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Location", "Sender", "Receiver", "Status", "Number of Volunteers"
            }
        ) {
    ...
    private void btnProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessRequestActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            ngoVolunteerRequest request = (ngoVolunteerRequest) tblWorkRequest.getValueAt(selectedRow, 0);

            if (request.getStatus().equals("Rejected")) {
                JOptionPane.showMessageDialog(null, "Selected Rejected Request", "Warning!", JOptionPane.WARNING_MESSAGE);
                return;
            }
            if (request.getStatus().equalsIgnoreCase("Sent to Resource Coordinator")) {
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : NgohealthCareOfficerOrganization.getWorkQueue().getWorkRequests()) {
