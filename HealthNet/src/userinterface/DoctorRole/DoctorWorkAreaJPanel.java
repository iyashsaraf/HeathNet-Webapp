...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblWorkRequest.setBackground(new java.awt.Color(242, 242, 242));
        ...
        btnRequestLab.setBackground(new java.awt.Color(0, 0, 0));
        btnRequestLab.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        btnRequestLab.setForeground(new java.awt.Color(153, 255, 204));
        ...
        lblMedicalTestWorkQueue.setBackground(new java.awt.Color(0, 0, 0));
        lblMedicalTestWorkQueue.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblMedicalTestWorkQueue.setForeground(new java.awt.Color(153, 255, 204));
        lblMedicalTestWorkQueue.setText("Medical Test Work Queue");

        btnAssignToMe.setBackground(new java.awt.Color(0, 0, 0));
        btnAssignToMe.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        btnAssignToMe.setForeground(new java.awt.Color(153, 255, 204));
        ...
        btnPrescribe.setBackground(new java.awt.Color(0, 0, 0));
        btnPrescribe.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        btnPrescribe.setForeground(new java.awt.Color(153, 255, 204));
        ...
        btnTreated.setBackground(new java.awt.Color(0, 0, 0));
        btnTreated.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        btnTreated.setForeground(new java.awt.Color(153, 255, 204));
        ...
        btnViewPatient.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        btnViewPatient.setForeground(new java.awt.Color(153, 255, 204));
        ...
        lblWorkAreaForDoctors.setBackground(new java.awt.Color(0, 0, 0));
        lblWorkAreaForDoctors.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblWorkAreaForDoctors.setForeground(new java.awt.Color(153, 255, 204));
    ...
    private void btnPrescribeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrescribeActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            {
            if (userAccount.equals(workRequest.getAssignedDoctor())) {
                if (workRequest.getStatus().equalsIgnoreCase("Lab Test is Completed") || workRequest.getStatus().equalsIgnoreCase("Under Consultation")) {
