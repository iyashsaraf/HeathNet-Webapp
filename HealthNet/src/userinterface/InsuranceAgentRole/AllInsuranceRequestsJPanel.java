...
public class AllInsuranceRequestsJPanel extends javax.swing.JPanel {
    ...
    public AllInsuranceRequestsJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise,
            InsuranceAgentOrganization insuranceAgentOrganization) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblInsuranceWorkload.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "PolicyNumber", "Patient Name", "Health Center", "Sender ", "Receiver Agent", "Billing Amount",
                        "Claim Amount", "Status"
                }) {
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(23, 23, 23)
                                                .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 959,
                                                        Short.MAX_VALUE))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(btnProcessRequest, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnAssign, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnProcessRequestActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (workRequest.getStatus().equals("Rejected")) {
                JOptionPane.showMessageDialog(null, "Sorry, Unable to process a rejected request !", "Warning!",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            if (workRequest.getStatus().equalsIgnoreCase("Sent to Secretary")) {
                JOptionPane.showMessageDialog(null, "Request has been already processed", "Warning!",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            if (!userAccount.equals(workRequest.getReceiver())) {
                ...
                userProcessContainer.add("ProcessRequestJPanel",
                        new ProcessRequestJPanel(userProcessContainer, userAccount, enterprise, workRequest));
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            InsuranceWorkRequest insuranceWorkRequest = (InsuranceWorkRequest) tblInsuranceWorkload
            ...
            if (insuranceWorkRequest.getStatus().equals("Sent")) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Can't assign this request, as it is in " + insuranceWorkRequest.getStatus() + " status",
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : insuranceAgentOrganization.getWorkQueue().getWorkRequests()) {
            ...
            row[1] = ((InsuranceWorkRequest) request).getInsuranceCustomer().getFirstName() + " "
                    + ((InsuranceWorkRequest) request).getInsuranceCustomer().getLastName();
