...
public class InsuranceAgentWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public InsuranceAgentWorkAreaJPanel(JPanel jpanel, UserAccount userAccount, Organization organization,
    ...
    private void initComponents() {
        ...
        btnAddNewMember.setBackground(new java.awt.Color(0, 0, 0));
        btnAddNewMember.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        btnAddNewMember.setForeground(new java.awt.Color(153, 255, 204));
        btnAddNewMember.setText("Create New Member");
        btnAddNewMember.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnProcessRequests.setBackground(new java.awt.Color(0, 0, 0));
        btnProcessRequests.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        btnProcessRequests.setForeground(new java.awt.Color(153, 255, 204));
        btnProcessRequests.setText("Process Insurance Requests");
        btnProcessRequests.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
    ...
    private void btnAddNewMemberActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAddNewMemberActionPerformed
        ...
        userProcessContainer.add("AddNewPolicyHolderJPanel",
                new AddNewPolicyHolderJPanel(userProcessContainer, userAccount, enterprise, policyNumber));
    ...
    private void btnProcessRequestsActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnProcessRequestsActionPerformed
        ...
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("ProcessInsuranceRequestsJPanel", new AllInsuranceRequestsJPanel(userProcessContainer,
                userAccount, enterprise, insuranceAgentOrganization));
        layout.next(userProcessContainer);
