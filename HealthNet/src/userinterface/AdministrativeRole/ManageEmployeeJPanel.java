...
public class ManageEmployeeJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnCreateEmployee.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        btnCreateEmployee.setForeground(new java.awt.Color(153, 255, 204));
        ...
        cbOrganizations.setBackground(new java.awt.Color(242, 242, 242));
        cbOrganizations.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        ...
        lblOrganization.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblOrganization.setForeground(new java.awt.Color(153, 255, 204));
        ...
        cbOrganizationEmployee.setBackground(new java.awt.Color(242, 242, 242));
        cbOrganizationEmployee.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        cbOrganizationEmployee.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        lblSelectOrganization.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblSelectOrganization.setForeground(new java.awt.Color(153, 255, 204));
        lblSelectOrganization.setText("ORGANIZATION");

        lblManageEmployee.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblManageEmployee.setForeground(new java.awt.Color(153, 255, 204));
