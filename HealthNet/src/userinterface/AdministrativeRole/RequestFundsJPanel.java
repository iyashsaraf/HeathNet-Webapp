...
//    }
    ...
    private void initComponents() {
        ...
        add(lblLocation);
        lblLocation.setBounds(50, 69, 80, 20);
        ...
        add(lblPopulation);
        lblPopulation.setBounds(50, 110, 97, 20);

        txtPopulation.setBackground(new java.awt.Color(242, 242, 242));
        ...
        add(lblAmount);
        lblAmount.setBounds(70, 150, 69, 20);
        ...
        tblFundRequest.setBackground(new java.awt.Color(242, 242, 242));
        tblFundRequest.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        ...
        jLabel4.setText("ALL FUNDS RECEIVED");
        add(jLabel4);
        ...
        txtFundsReceived.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtFundsReceivedActionPerformed(evt);
            }
        });
    ...
    private void txtFundsReceivedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtFundsReceivedActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtFundsReceivedActionPerformed
