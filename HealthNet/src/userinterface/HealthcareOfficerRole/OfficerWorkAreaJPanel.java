...
public class OfficerWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public OfficerWorkAreaJPanel(JPanel jpanel, UserAccount userAccount, Organization organization,
    ...
    private void initComponents() {
        ...
        btnAssign.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        ...
        btnProcessRequest.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(217, 217, 217)
                                                .addComponent(lblHealthOfficer, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        413, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(276, 276, 276)
                                                .addComponent(btnAssign, javax.swing.GroupLayout.PREFERRED_SIZE, 132,
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGap(36, 36, 36)
                                .addComponent(lblHealthOfficer, javax.swing.GroupLayout.PREFERRED_SIZE, 33,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(29, 29, 29)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(btnProcessRequest, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnAssign, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnProcessRequestActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (request.getStatus().equals("Rejected")) {
                JOptionPane.showMessageDialog(null, "Selected Rejected Request", "Warning!",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            if (request.getStatus().equalsIgnoreCase("Sent to Secretary")) {
                JOptionPane.showMessageDialog(null, "Request is already processed", "Warning!",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            if (!userAccount.getEmployee().equals(request.getReceiver().getEmployee())) {
                JOptionPane.showMessageDialog(null, "Request is not assigned to you !", "Warning!",
                        JOptionPane.WARNING_MESSAGE);
                return;
            } else {

                OfficerProcessWorkRequestJPanel panel = new OfficerProcessWorkRequestJPanel(jPanel, userAccount,
                        request, enterprise);
