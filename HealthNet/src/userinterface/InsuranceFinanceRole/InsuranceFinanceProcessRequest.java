...
public class InsuranceFinanceProcessRequest extends javax.swing.JPanel {
     ...
     */
    InsuranceFinanceProcessRequest(JPanel userProcessContainer, UserAccount userAccount,
            InsuranceWorkRequest insuranceWorkRequest, Enterprise enterprise) {
        initComponents();
        ...
        txtCoveragePercent.setText(
                String.valueOf(insuranceWorkRequest.getInsuranceCustomer().getInsurance().getCoveragepercentage()));
    }
    ...
    private void initComponents() {
        ...
        btnDisburseAmt.setForeground(new java.awt.Color(153, 255, 204));
        btnDisburseAmt.setText("Disburse Amount");
        btnDisburseAmt.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnRejectClaim.setForeground(new java.awt.Color(153, 255, 204));
        btnRejectClaim.setText("Reject Claim");
        btnRejectClaim.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        lblBillingAmt.setForeground(new java.awt.Color(153, 255, 204));
