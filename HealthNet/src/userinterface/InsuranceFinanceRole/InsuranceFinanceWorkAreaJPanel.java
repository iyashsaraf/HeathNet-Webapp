...
public class InsuranceFinanceWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public InsuranceFinanceWorkAreaJPanel(JPanel userProcessContainer, UserAccount account,
            InsuranceFinanceOrganization insuranceFinanceOrganization, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblInsuranceFinanceWorkArea.setForeground(new java.awt.Color(153, 255, 204));
        ...
        tblFinance.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Policy Number", "Policy Name", "Coverage%", "Claim Amount", "Bill Amount",
                        "Insurance Claim Status", "Requesting HealthCenter ", "Finance Manager"
                }) {
        ...
        btnAssignToSelf.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnProcessRequest.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(256, 256, 256)
                                                .addComponent(btnAssignToSelf, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        166, Short.MAX_VALUE)
                                                .addGap(54, 54, 54)
                                                .addComponent(btnProcessRequest, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        172, Short.MAX_VALUE)
                                                .addGap(261, 261, 261)))
                                .addContainerGap())
                        .addGroup(layout.createSequentialGroup()
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(btnProcessRequest, javax.swing.GroupLayout.DEFAULT_SIZE, 38,
                                                Short.MAX_VALUE)
                                        .addComponent(btnAssignToSelf, javax.swing.GroupLayout.DEFAULT_SIZE, 38,
                                                Short.MAX_VALUE))
                                .addGap(268, 268, 268)));
        ...
        if (selectedRow < 0) {
            ...
            if (request.getStatus().equals("Sent To Finance Department")) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Can't assign this work request, as the work request is in " + request.getStatus() + " status",
    ...
    private void btnProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnProcessRequestActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (insuranceWorkRequest.getStatus().equalsIgnoreCase("Insurance Claim Approved")) {
                JOptionPane.showMessageDialog(null, "Request already Completed", "Warning!",
            ...
            if (!userAccount.getEmployee().equals(insuranceWorkRequest.getReceiver().getEmployee())) {
                JOptionPane.showMessageDialog(null, "Request assigned to other Officer", "Warning!",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            if (insuranceWorkRequest.getStatus().equals("Insurance Claim Rejected")) {
                JOptionPane.showMessageDialog(null, "Cannot process a Rejected Request", "Warning!",
                        JOptionPane.WARNING_MESSAGE);
                return;
            } else {

                InsuranceFinanceProcessRequest panel = new InsuranceFinanceProcessRequest(userProcessContainer,
                        userAccount, insuranceWorkRequest, enterprise);
    ...
    // insuranceFinanceOrganization.getWorkQueue().getWorkRequests()) {
    // InsuranceWorkRequest insuranceworkRequest = ((InsuranceWorkRequest)
    // workRequest);
    // Object[] row = new Object[8];
    // row[0] = insuranceworkRequest;
    // row[1] = insuranceworkRequest.getPolicyName();
    // row[2] =
    // insuranceworkRequest.getInsuranceCustomer().getInsurance().getCoveragepercentage();
    ...
    // row[7] = insuranceworkRequest.getReceiver() == null ? "" :
    // insuranceworkRequest.getReceiver().getEmployee().getEmployeename();
    //
    // model.addRow(row);
    // }
    //
    ...
    public void populateTable() {
        ...
        if (insuranceFinanceOrganization == null || insuranceFinanceOrganization.getWorkQueue() == null) {
        ...
        for (WorkRequest workRequest : insuranceFinanceOrganization.getWorkQueue().getWorkRequests()) {
            if (workRequest instanceof InsuranceWorkRequest) {
                ...
                Object[] row = new Object[8];
                row[0] = insuranceWorkRequest; // Ensure proper getter is used
                row[1] = insuranceWorkRequest.getPolicyName();
