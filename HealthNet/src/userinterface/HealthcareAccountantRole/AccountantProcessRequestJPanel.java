...
public class AccountantProcessRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblBillingRequestArea.setBackground(new java.awt.Color(0, 0, 0));
        lblBillingRequestArea.setFont(new java.awt.Font("Avenir Next", 1, 24)); // NOI18N
        lblBillingRequestArea.setForeground(new java.awt.Color(153, 255, 204));
        ...
        lblBillAmount.setBackground(new java.awt.Color(0, 0, 0));
        lblBillAmount.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblBillAmount.setForeground(new java.awt.Color(153, 255, 204));
        ...
        lblAmountPayable.setBackground(new java.awt.Color(0, 0, 0));
        lblAmountPayable.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblAmountPayable.setForeground(new java.awt.Color(153, 255, 204));
        lblAmountPayable.setText("Payable Amount :");

        btnSendRequestForInsurance.setBackground(new java.awt.Color(0, 0, 0));
        btnSendRequestForInsurance.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        btnSendRequestForInsurance.setForeground(new java.awt.Color(153, 255, 204));
        ...
        lblPolicyNumber.setBackground(new java.awt.Color(0, 0, 0));
        lblPolicyNumber.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblPolicyNumber.setForeground(new java.awt.Color(153, 255, 204));
        lblPolicyNumber.setText("Policy Number :");

        lblAmountClaimed.setBackground(new java.awt.Color(0, 0, 0));
        lblAmountClaimed.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        lblAmountClaimed.setForeground(new java.awt.Color(153, 255, 204));
        lblAmountClaimed.setText("Amount to be Claimed :");

        txtAmountClaimed.setEditable(false);

        backJButton.setBackground(new java.awt.Color(0, 0, 0));
        backJButton.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        backJButton.setForeground(new java.awt.Color(153, 255, 204));
        ...
        btnCollectCash.setBackground(new java.awt.Color(0, 0, 0));
        btnCollectCash.setFont(new java.awt.Font("Avenir Next", 1, 14)); // NOI18N
        btnCollectCash.setForeground(new java.awt.Color(153, 255, 204));
    ...
    private void btnSendRequestForInsuranceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendRequestForInsuranceActionPerformed
        ...
        if (("Pending on"+accountantBillingRequest.getStatus()).equals(accountantBillingRequest.getStatus())) {
        ...
        if (insuranceWorkRequest.getStatus().equals("Sent")) {
          ...
          } else if (insuranceWorkRequest.getStatus().equals("Insurance Claim Approved")) {
              accountantBillingRequest.setStatus("Patient Transaction Completed");
              JOptionPane.showMessageDialog(null, 
                  "Money received from patient: " + String.format("%.2f", amountToBePaid) +
                  ". Insurance Claim Approved Successfully for amount: " + claimAmount);
              
          } else if (insuranceWorkRequest.getStatus().equals("Insurance Claim Rejected")) {
              accountantBillingRequest.setStatus("Pending on acckiran");
              JOptionPane.showMessageDialog(null, 
                  "Insurance Claim is Rejected. Please Pay Directly to the Given Account Details. Thank You");
        }

    
    
//        System.out.println(accountantBillingRequest.getStatus());
