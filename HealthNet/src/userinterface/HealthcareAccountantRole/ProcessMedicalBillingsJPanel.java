...
public class ProcessMedicalBillingsJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblReceptionistPatientBillingArea.setBackground(new java.awt.Color(0, 0, 0));
        lblReceptionistPatientBillingArea.setFont(new java.awt.Font("Avenir Next", 1, 24)); // NOI18N
        lblReceptionistPatientBillingArea.setForeground(new java.awt.Color(153, 255, 204));
        lblReceptionistPatientBillingArea.setText("Receptionist: Patient Billing Area");

        tblInsurance.setBackground(new java.awt.Color(242, 242, 242));
        ...
        lblInsuranceClaimStatusTable.setBackground(new java.awt.Color(0, 0, 0));
        lblInsuranceClaimStatusTable.setFont(new java.awt.Font("Avenir Next", 1, 18)); // NOI18N
        lblInsuranceClaimStatusTable.setForeground(new java.awt.Color(153, 255, 204));
        lblInsuranceClaimStatusTable.setText("Insurance Claim Status Table");

        lblPatientBillingTable.setBackground(new java.awt.Color(0, 0, 0));
        lblPatientBillingTable.setFont(new java.awt.Font("Avenir Next", 1, 18)); // NOI18N
        lblPatientBillingTable.setForeground(new java.awt.Color(153, 255, 204));
    ...
    private void btnProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessRequestActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (accountBillingRequest.getReceiver() != null) {
                if (accountBillingRequest.getReceiver().equals(userAccount)) {
                    if (accountBillingRequest.getStatus().equalsIgnoreCase("Pending on " + accountBillingRequest.getReceiver().getEmployee().getEmployeename()) || 
                        accountBillingRequest.getStatus().equalsIgnoreCase("Patient Transaction Completed")) {
            ...
            System.out.println("Pending on " + accountBillingRequest.getReceiver().getEmployee().getEmployeename());
        }
